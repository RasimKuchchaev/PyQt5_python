...
class DlgMain(QDialog):
    def __init__(self):
        ...
        self.rbtRed.setChecked(True)        # setChecked - выбрать кнопку
        ...
        self.rbtSmall.setChecked(True)        # setChecked - выбрать кнопку
    ...
    def evt_rbt_clicked(self):
        # rbt = self.sender()         # sender() - получаем нажатую кнопку
